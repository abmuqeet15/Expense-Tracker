...
def add_transaction(transaction_type, category, amount, description, date):
    ...
    try:
        ...
        success_msg = f"✅ {transaction_type} of Rs{amount:.2f} added successfully!"
...
with gr.Blocks(css=css, title="💰 Expense Tracker", theme=gr.themes.Soft()) as app:
    gr.HTML("<h1 style='text-align: center; margin-bottom: 30px;'>💰 Personal Expense Tracker by ABM</h1>")
